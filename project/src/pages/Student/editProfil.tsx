...
function EditProfil() {
    ...
    useEffect(() => {
        const fetchWilayah = async () => {
            try {
                const provinsiRes = await axios.get("https://kawalptn.store/admin/region/province");
    ...
    const handleProvinsiChange = async (selected: any) => {
        ...
        const kabRes = await axios.get(`https://kawalptn.store/admin/region/regency/${selected.value}`);
    ...
    const handleKabupatenChange = async (selected: any) => {
        ...
        const kecRes = await axios.get(`https://kawalptn.store/admin/region/subdistrict/${selected.value}`);
    ...
    const handleKecamatanChange = async (selected: any) => {
        ...
        try {
            const sekolahRes = await axios.get(
                `https://kawalptn.store/admin/listSekolah/${selectedProvinsi}/${selectedKabupaten}/${kecamatanId}`
            );
    ...
    const handlePtn1Change = async (selected: any) => {
        ...
        try {
            const prodi1Res = await axios.get(
                `https://kawalptn.store/admin/listMajor/${pilihan1Id}`
            );
    ...
    const handlePtn2Change = async (selected: any) => {
        ...
        try {
            const prodi2Res = await axios.get(
                `https://kawalptn.store/admin/listMajor/${pilihan2Id}`
            );
    ...
    const handlePtn3Change = async (selected: any) => {
        ...
        try {
            const prodi3Res = await axios.get(
                `https://kawalptn.store/admin/listMajor/${pilihan3Id}`
            );
    ...
    const handlePtn4Change = async (selected: any) => {
        ...
        try {
            const prodi4Res = await axios.get(
                `https://kawalptn.store/admin/listMajor/${pilihan4Id}`
            );
        ...
        try {
            ...
            if (selectedFile) {
                ...
                reader.onloadend = () => {
                    ...
                    axios.put(
                        `https://kawalptn.store/student/update/${studentData.id}`,
                        params.toString(),
                        {
                            withCredentials: true,
                            headers: {

...
function Profil() {
    ...
    useEffect(() => {
        const fetchStudent = async () => {
            ...
            try {
                ...
                const [sekolahRes, prodi1Res, prodi2Res, prodi1AktualRes, prodi2AktualRes] = await Promise.all([
                    axios.get(`https://160.19.166.155:8000/admin/viewSekolah/${data.asal_sekolah}`),
                    axios.get(`https://160.19.166.155:8000/admin/viewMajor/${data.pilihan1_utbk}`),
                    axios.get(`https://160.19.166.155:8000/admin/viewMajor/${data.pilihan2_utbk}`),
                    axios.get(`https://160.19.166.155:8000/admin/viewMajor/${data.pilihan1_utbk_aktual}`),
                    axios.get(`https://160.19.166.155:8000/admin/viewMajor/${data.pilihan2_utbk_aktual}`),
                ]);
        ...
        const fetchSchools = async () => {
            try {
                const response = await axios.get("https://160.19.166.155:8000/admin/listSekolah", {
                    withCredentials: true,
                });
            ...
            <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex sp-4 space-y-2">
                        ...
                        <div className="w-1/4">
                            <img className="w-[7em] h-auto mt-4 ml-5" src={`https://160.19.166.155:8000/${studentData.foto?.replace(/\\/g, "/")}`} />
                        </div>
                    </div>
                </div>
                <div className="mb-6">

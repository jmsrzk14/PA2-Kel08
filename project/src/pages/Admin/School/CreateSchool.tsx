...
const TambahSekolah = () => {
  ...
  useEffect(() => {
    fetch("https://160.19.166.155:8000/admin/region/province")
      .then(res => res.json())
      .then(data => {
  ...
  useEffect(() => {
    if (provinsi) {
      fetch(`https://160.19.166.155:8000/admin/region/regency/${provinsi.value}`)
        .then(res => res.json())
        .then(data => {
  ...
  useEffect(() => {
    if (kabupaten) {
      fetch(`https://160.19.166.155:8000/admin/region/subdistrict/${kabupaten.value}`)
        .then(res => res.json())
        .then(data => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch("https://160.19.166.155:8000/admin/createSekolah", {
        method: "POST",
        headers: {
